    ...
    <div class="flex flex-col gap-6">
            ...
            <nav>
                <ol class="flex items-center gap-1.5 text-sm">
                    <li><a class="font-medium text-gray-400 dark:text-amoled-text hover:text-school-blue transition duration-150"
                            href="{{ route('verification.index') }}">Verifikasi</a></li>
        ...
        @if (!$industry->is_synced && $industry->status !== 'blacklisted')
            <div
                ...
                <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Tentukan apakah industri ini sesuai dengan
                        kurikulum program keahlian Anda.</p>
                </div>
                <div class="p-6 sm:p-8">
        ...
        @if (!$industry->is_synced && $industry->status === 'blacklisted')
            <div
                ...
                <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Pengajuan ini sebelumnya telah ditolak. Anda
                        dapat mencabut penolakan untuk meninjau ulang.</p>
                </div>
                <div class="p-6 sm:p-8">
        ...
        @if ($industry->is_synced)
            <div
                ...
                <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                    <h3 class="text-sm font-semibold text-gray-500 dark:text-amoled-text">Revisi Keputusan</h3>
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Anda sebelumnya telah menyetujui industri
                        ini. Sinkronisasi dapat dicabut selama belum ada siswa yang tertaut.</p>
                </div>
                <div class="p-6 sm:p-8">
