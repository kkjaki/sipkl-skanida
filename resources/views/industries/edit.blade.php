...
@section('content')
    <div class="flex flex-col gap-6">
        ...
        @if ($industry->student_submitter_id)
            <div
                class="flex w-full border-l-4 border-violet-500 bg-white dark:bg-amoled-surface px-4 py-3 shadow-sm rounded-r-xl">
                <div class="w-full flex items-center gap-2">
                    <svg class="w-5 h-5 text-violet-500 shrink-0" width="20" height="20" fill="none"
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-amoled-border dark:bg-amoled-surface">
            <form action="{{ route('industries.update', $industry->id) }}" method="POST">
                ...
                <div class="p-6 sm:p-8 space-y-6 border-b border-gray-200 dark:border-amoled-border">
                    <div>
                        <label for="name" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Nama
                            Industri <span class="text-red-500">*</span></label>
                        <input type="text" id="name" name="name" value="{{ old('name', $industry->name) }}"
                            placeholder="cth. PT. Telkom Indonesia" required
                    ...
                    <div>
                        <label for="city" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Kota
                            <span class="text-red-500">*</span></label>
                        <input type="text" id="city" name="city" value="{{ old('city', $industry->city) }}"
                            placeholder="cth. Magelang" required
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                        @error('city')
                            <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="contact_person"
                            class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Contact Person</label>
                        <input type="text" id="contact_person" name="contact_person"
                            value="{{ old('contact_person', $industry->contact_person) }}" placeholder="cth. Bapak Agus"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                    ...
                    <div>
                        <label for="email" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-400">Email
                            <span class="text-red-500">**</span></label>
                        <p class="mb-1.5 text-xs text-gray-400 dark:text-gray-500">Wajib diisi jika No. Telepon tidak diisi.
                        </p>
                        <input type="email" id="email" name="email" value="{{ old('email', $industry->email) }}"
                            placeholder="cth. humas@perusahaan.com"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                        @error('email')
                            <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="phone" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-400">No.
                            Telepon <span class="text-red-500">**</span></label>
                        <p class="mb-1.5 text-xs text-gray-400 dark:text-gray-500">Wajib diisi jika Email tidak diisi.
                            (<span class="text-red-500">**</span>) Minimal salah satu harus diisi.</p>
                        <input type="text" id="phone" name="phone" value="{{ old('phone', $industry->phone) }}"
                            placeholder="cth. 08123456789 / 0293-123456"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                        @error('phone')
                            <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                        @enderror
                ...
                <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                    <h3 class="text-sm font-semibold text-gray-500 dark:text-amoled-text">Data Penanggung Jawab (PIC)
                        Sertifikat</h3>
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Data yang akan dicetak pada sertifikat siswa.
                    </p>
                </div>
                <div class="p-6 sm:p-8 space-y-6 border-b border-gray-200 dark:border-amoled-border">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label for="pic_name"
                                class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Nama Penanggung
                                Jawab</label>
                            <input type="text" id="pic_name" name="pic_name"
                                value="{{ old('pic_name', $industry->pic_name) }}" placeholder="Nama Lengkap & Gelar"
                                class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                            @error('pic_name')
                                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" id="pic_position" name="pic_position"
                                value="{{ old('pic_position', $industry->pic_position) }}"
                                placeholder="cth. Direktur / HRD Manager"
                                class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                            @error('pic_position')
                                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label for="nip"
                                class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">NIP
                                (Opsional)</label>
                            <input type="text" id="nip" name="nip"
                                value="{{ old('nip', $industry->nip) }}" placeholder="cth. 19800101..."
                                class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                            @error('nip')
                                <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                            @enderror
                ...
                @if ($industry->is_synced && $industry->status !== 'blacklisted')
                    <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                        <h3 class="text-sm font-semibold text-gray-500 dark:text-amoled-text">Alokasi Kuota per Program
                            Keahlian</h3>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Masukkan 0 atau kosongkan jika program
                            keahlian tidak dialokasikan.</p>
                    </div>
                    <div class="p-6 sm:p-8 space-y-4 border-b border-gray-200 dark:border-amoled-border">
                        @if (isset($hasOngoingInternships) && $hasOngoingInternships)
                            <div
                                class="flex w-full border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20 px-4 py-3 rounded-r-xl">
                                <div class="w-full flex items-center gap-2">
                                    <svg class="w-5 h-5 text-red-500 shrink-0" width="20" height="20"
                                    ...
                                    <p class="text-sm text-red-600 dark:text-red-400 font-medium">
                                        Kuota tidak dapat diubah karena terdapat siswa yang sedang menjalani PKL (ongoing)
                                        di industri ini.
                                    </p>
                                </div>
                            </div>
                        ...
                        @foreach ($departments as $dept)
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                                <label for="quota_{{ $dept->id }}"
                                    class="sm:w-1/2 text-sm font-medium text-gray-700 dark:text-gray-400">
                                    {{ $dept->name }} <span class="text-xs text-gray-400">({{ $dept->code }})</span>
                                </label>
                                <input type="number" id="quota_{{ $dept->id }}" name="quotas[{{ $dept->id }}]"
                                    value="{{ old('quotas.' . $dept->id, $existingQuotas[$dept->id] ?? 0) }}"
                                    min="0"
                ...
                @else
                    <div class="p-6 sm:p-8 border-b border-gray-200 dark:border-amoled-border">
                        <div
                            class="flex w-full border-l-4 border-amber-500 bg-amber-50 dark:bg-amber-500/10 px-4 py-3 rounded-r-xl">
                            <div class="w-full flex items-center gap-2">
                                <svg class="w-5 h-5 text-amber-500 shrink-0" width="20" height="20"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.27 16.5c-.77.833.192 2.5 1.732 2.5z">
                                    </path>
                                ...
                                <p class="text-sm text-amber-600 dark:text-amber-400 font-medium">
                                    ...
                                    @else
                                        Industri ini belum diverifikasi oleh Kaprog. Kuota hanya dapat dialokasikan setelah
                ...
                <div class="p-6 sm:p-8">
                    <div class="flex items-center justify-end gap-3">
                        <a href="{{ route('industries.index') }}"
                            class="inline-flex items-center justify-center rounded-xl border border-gray-200 dark:border-amoled-border bg-transparent py-2.5 px-6 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.06] transition duration-150 ease-in-out">Batal</a>
                        <button type="submit"
