    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="rounded-xl bg-blue-500/5 border border-blue-500/10 px-4 py-3">
            <p class="text-xs text-blue-500 dark:text-blue-400 font-medium flex items-center gap-1.5">
                <svg class="w-4 h-4 shrink-0" width="16" height="16" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <form action="{{ route('student.proposals.update', $proposal) }}" method="POST">
                ...
                <div class="p-6 sm:p-8 space-y-6 border-b border-gray-200 dark:border-amoled-border">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $proposal->name) }}"
                            placeholder="cth. CV. Maju Jaya" required
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3" placeholder="cth. Jl. Raya Magelang No. 45" required
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city', $proposal->city) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="contact_person" name="contact_person"
                            ...
                            placeholder="cth. Bapak/Ibu Humas"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition duration-150 focus:border-school-blue focus:ring-3 focus:ring-school-blue/10 dark:border-amoled-border dark:bg-amoled-input dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-school-blue" />
                    ...
                    <div>
                        <label for="email" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-400">Email
                            <span class="text-red-500">**</span></label>
                        <p class="mb-1.5 text-xs text-gray-400 dark:text-gray-500">Wajib diisi jika No. Telepon / WA tidak
                            diisi.</p>
                        <input type="email" id="email" name="email" value="{{ old('email', $proposal->email) }}"
                    ...
                    <div>
                        ...
                        <p class="mb-1.5 text-xs text-gray-400 dark:text-gray-500">Wajib diisi jika Email tidak diisi.
                            (<span class="text-red-500">**</span>) Minimal salah satu harus diisi agar sekolah dapat
                            menghubungi industri.</p>
                        <input type="text" id="phone" name="phone" value="{{ old('phone', $proposal->phone) }}"
