    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-amoled-border dark:bg-amoled-surface">
            ...
            <div class="p-6 sm:p-8">
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <div>
                        <dt class="text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wide">No. Telepon
                        </dt>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-amoled-border dark:bg-amoled-surface">
            <form action="{{ route('industries.storeAllocation', $industry->id) }}" method="POST">
                ...
                <div class="border-b border-gray-200 dark:border-amoled-border py-4 px-6 sm:px-8">
                    <h3 class="text-sm font-semibold text-gray-500 dark:text-amoled-text">Alokasi Kuota per Program Keahlian
                    </h3>
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Hubungi industri untuk mengetahui berapa
                        siswa yang dapat diterima. Minimal total kuota harus 1.</p>
                </div>
                        ...
                        <div
                            ...
                            <div class="w-full flex items-center gap-2">
                                ...
                                <p class="text-sm text-red-600 dark:text-red-400 font-medium">
                                    Kuota tidak dapat diubah karena terdapat siswa yang sedang menjalani PKL (ongoing) di
                                    industri ini.
                                </p>
                            </div>
                        </div>
