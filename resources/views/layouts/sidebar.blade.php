<aside
    class="fixed left-0 top-0 z-50 flex h-screen flex-col overflow-y-hidden bg-white dark:bg-amoled-surface duration-300 ease-linear lg:static lg:translate-x-0 border-r border-gray-200 dark:border-amoled-border"
    :class="{
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    <li>
                        ...
                        >
                            <svg class="fill-current w-5 h-5" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">Departments</span>
                        </a>
                    </li>
                </ul>
            </div>
