<aside
    ...
    @mouseleave="$store.sidebar.setHovered(false)" @click.outside="$store.sidebar.setMobileOpen(false)">
    <!-- Logo -->
    <div class="flex items-center justify-center px-6 py-5 h-[72px] border-b border-gray-200 dark:border-amoled-border">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
            <img src="{{ asset('images/logo-smkn2.webp') }}" alt="Logo SMKN 2 Magelang"
                class="w-10 h-10 object-contain flex-shrink-0" width="40" height="40">
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    <li>
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M16 0H2C0.89543 0 0 0.89543 0 2V16C0 17.1046 0.89543 18 2 18H16C17.1046 18 18 17.1046 18 16V2C18 0.89543 17.1046 0 16 0ZM7 16H2V11H7V16ZM16 16H9V11H16V16ZM7 9H2V2H7V9ZM16 9H9V2H16V9Z"
                                    fill="" />
                            </svg>
                            <span
                                x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                        ...
                        <li>
                            <a href="{{ route('departments.index') }}"
                                ...
                                <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                    viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M15 13H3V5H15V13ZM3 3C1.895 3 1 3.895 1 5V13C1 14.105 1.895 15 3 15H15C16.105 15 17 14.105 17 13V5C17 3.895 16.105 3 15 3H3ZM8 7H13V9H8V7ZM4 7H6V9H4V7ZM4 10H6V12H4V10ZM8 10H13V12H8V10Z"
                                        fill="" />
                                </svg>
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Program Keahlian</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('academic-years.index') }}"
                                ...
                                <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                    viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M14 2H13V0H11V2H5V0H3V2H2C0.9 2 0 2.9 0 4V16C0 17.1 0.9 18 2 18H14C15.1 18 16 17.1 16 16V4C16 2.9 15.1 2 14 2ZM14 16H2V7H14V16ZM14 5H2V4H14V5ZM4 9H10V15H4V9Z"
                                        fill="" />
                                </svg>
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Tahun Ajaran</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('supervisors.index') }}"
                                ...
                                <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                    viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10 10C12.21 10 14 8.21 14 6C14 3.79 12.21 2 10 2C7.79 2 6 3.79 6 6C6 8.21 7.79 10 10 10ZM10 4C11.1 4 12 4.9 12 6C12 7.1 11.1 8 10 8C8.9 8 8 7.1 8 6C8 4.9 8.9 4 10 4ZM2 16V18H18V16C18 13.34 12.67 12 10 12C7.33 12 2 13.34 2 16ZM4 16C4.22 15.28 7.31 14 10 14C12.7 14 15.8 15.29 16 16H4Z"
                                        fill="" />
                                </svg>
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Guru Pembimbing</span>
                            </a>
                        </li>
                            ...
                            <a href="{{ route('industries.index') }}"
                                class="group relative flex items-center gap-2.5 rounded-xl px-4 py-2.5 font-medium text-sm duration-200 ease-in-out
                                  {{ request()->routeIs('industries.*')
                                      ? 'bg-school-blue/10 text-school-blue dark:bg-white/[0.08] dark:text-white'
                                      : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/[0.06] dark:hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" width="20" height="20" fill="none"
                        ...
                        <li>
                            <a href="{{ route('evaluation-indicators.index') }}"
                                ...
                                <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                    viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2 10C2 5.58 5.58 2 10 2C14.42 2 18 5.58 18 10C18 14.42 14.42 18 10 18C5.58 18 2 14.42 2 10ZM4 10C4 13.31 6.69 16 10 16C13.31 16 16 13.31 16 10C16 6.69 13.31 4 10 4C6.69 4 4 6.69 4 10ZM11 11H9V6H11V11ZM11 14H9V12H11V14Z"
                                        fill="" />
                                </svg>
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Indikator Penilaian</span>
                            </a>
                        </li>
                    ...
                    <ul class="mb-6 flex flex-col gap-1">
                        ...
                        <li>
                            <a href="{{ route('student.proposals.index') }}"
                                ...
                                <svg class="fill-current w-5 h-5 flex-shrink-0" width="20" height="20"
                                    viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M4 4C4 2.89543 4.89543 2 6 2H10.5858C11.1162 2 11.6249 2.21071 12 2.58579L15.4142 6C15.7893 6.37507 16 6.88378 16 7.41421V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4ZM14 16V8H11C10.4477 8 10 7.55228 10 7V4H6V16H14ZM12 4.41421L13.5858 6H12V4.41421ZM7 10H13V12H7V10ZM7 13H11V15H7V13Z"
                                        fill="" />
                                </svg>
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Pengajuan Lokasi</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('student.certificate-validations.index') }}"
                                ...
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Validasi Sertifikat</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="mb-6 flex flex-col gap-1">
                        ...
                        <li>
                            <a href="{{ route('verification.index') }}"
                                ...
                                <span
                                    x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                    x-cloak>Verifikasi Industri</span>
                            </a>
                        </li>
                    </ul>
                </div>
