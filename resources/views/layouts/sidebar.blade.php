                ...
                <ul class="mb-6 flex flex-col gap-1">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" x-cloak>Kerjasama (MoU)</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" x-cloak>PKL Aktif</span>
                        </a>
                    </li>
                </ul>
            </div>
