<header
    ...
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        {{-- Left Side: Sidebar Toggle + Mobile Logo + Mobile menu button --}}
        <div
            class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-amoled-border sm:gap-4 lg:w-auto lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
            ...
            <button
                class="flex lg:hidden items-center justify-center w-10 h-10 text-gray-500 rounded-xl dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/[0.06]"
            ...
            <a href="{{ route('dashboard') }}" class="lg:hidden flex flex-col items-center leading-tight">
                ...
                <span class="text-[10px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">SMKN 2
                    Magelang</span>
            </a>
        ...
        {{-- Right Side Actions: Desktop (always visible, no Alpine x-show) --}}
        ...
        {{-- Right Side Actions: Mobile (toggled by Alpine, hidden on desktop) --}}
