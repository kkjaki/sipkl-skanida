<div class="relative" x-data="{
    ...
    <button
        ...
        <!-- Notification Badge -->
        <span x-show="notifying" class="absolute right-0 top-0.5 z-1 h-2 w-2 rounded-full bg-school-orange">
            <span
                class="absolute inline-flex w-full h-full bg-school-orange rounded-full opacity-75 -z-1 animate-ping"></span>
        </span>
