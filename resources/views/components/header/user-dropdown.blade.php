        ...
        <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-amoled-border">
            <li>
                <a href="{{ route('profile.edit') }}"
                    class="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-xl group text-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/[0.06] dark:hover:text-gray-300">
                    <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300"
