    ...
    <div class="flex flex-col gap-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-amoled-border dark:bg-amoled-surface">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="mt-2 text-3xl font-bold {{ $siswaBelumPkl > 0 ? 'text-red-500' : 'text-gray-400 dark:text-gray-500' }}">{{ $siswaBelumPkl }}</h3>
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">peserta didik</p>
                    </div>
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl {{ $siswaBelumPkl > 0 ? 'bg-red-500/10 dark:bg-red-500/20' : 'bg-gray-100 dark:bg-white/[0.06]' }}">
                        <svg class="w-6 h-6 {{ $siswaBelumPkl > 0 ? 'text-red-500' : 'text-gray-400 dark:text-gray-500' }}" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-amoled-border dark:bg-amoled-surface">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">mitra siap menerima siswa {{ $department->code }}</p>
                    </div>
        ...
        @else
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-amoled-border dark:bg-amoled-surface p-8 text-center">
                <svg class="mx-auto w-12 h-12 text-gray-300 dark:text-gray-600" width="48" height="48" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
