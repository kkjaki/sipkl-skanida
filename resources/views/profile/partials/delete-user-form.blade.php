<div x-data="{ showDeleteModal: false }"
    ...
    <div class="p-5 sm:p-6">
        <div class="mb-5">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Setelah akun dihapus, semua data akan hilang secara
                permanen. Pastikan Anda sudah mengunduh data yang diperlukan.</p>
        </div>
    ...
    <div x-show="showDeleteModal" class="fixed inset-0 z-[100]" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="relative w-full sm:max-w-md bg-white dark:bg-amoled-surface rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-amoled-border"
                ...
                <form method="post" action="{{ route('profile.destroy') }}" class="p-5 sm:p-6">
                    ...
                    <div class="text-center mb-5">
                        <div
                            class="w-12 h-12 rounded-full bg-red-100 dark:bg-red-500/15 flex items-center justify-center mx-auto mb-4">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Semua data akan dihapus secara permanen.
                            Masukkan password Anda untuk mengonfirmasi.</p>
                    </div>
