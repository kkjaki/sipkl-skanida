...
<body class="font-sans antialiased bg-gray-50 dark:bg-amoled min-h-screen">
    ...
    <div x-data="{ showForgotModal: false }" class="relative flex min-h-screen w-full flex-col lg:flex-row">
            ...
            <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-6 py-12">
                ...
                <div class="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left">
                    ...
                    {{-- ================================================
                     ...
                     ================================================ --}}
                    <div
                        class="mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl
                            bg-gray-100 dark:bg-amoled-surface border border-gray-200 dark:border-amoled-border">
                        <img src="{{ asset('images/logo-smkn2.webp') }}" alt="Logo SMKN 2 Magelang" width="64"
                            height="64" class="h-full w-full object-contain p-1.5"
                            onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                        {{-- Fallback SVG jika gambar belum ada --}}
                        <svg xmlns="http://www.w3.org/2000/svg" style="display:none" class="h-8 w-8 text-school-blue"
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                placeholder="nama@smkn2magelang.sch.id" required autofocus autocomplete="username"
                        ...
                        <div>
                            ...
                            <div x-data="{ showPwd: false }" class="relative">
                                ...
                                <button type="button" @click="showPwd = !showPwd"
                                    ...
                                    <svg x-show="showPwd" x-cloak class="w-5 h-5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <label for="remember_me"
                                    ...
                                    <div class="relative">
                                        ...
                                        <div :class="checked
                                            ...
                                            <span :class="checked ? 'opacity-100' : 'opacity-0'"
        ...
        <div
            class="relative hidden lg:flex flex-1 items-center justify-center bg-gray-100 dark:bg-amoled-surface overflow-hidden">
            ...
            {{-- ================================================
             ...
             ================================================ --}}
            <img src="{{ asset('images/school-building.jpg') }}" alt="Foto SMKN 2 Magelang"
            ...
            <div class="relative z-10 flex flex-col items-center text-center px-8 max-w-sm">
                ...
                {{-- Logo besar --}}
                <div
                    class="mb-6 flex h-24 w-24 items-center justify-center overflow-hidden rounded-3xl
                        bg-white dark:bg-amoled border border-gray-200 dark:border-amoled-border shadow-xl">
                    <img src="{{ asset('images/logo-smkn2.webp') }}" alt="Logo SMKN 2 Magelang" width="96"
                        height="96" class="h-full w-full object-contain p-2"
                        onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                    {{-- Fallback SVG --}}
                    <svg xmlns="http://www.w3.org/2000/svg" style="display:none" class="h-12 w-12 text-school-blue"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />
                    </svg>
        ...
        <div x-show="showForgotModal" x-cloak x-transition.opacity.duration.200ms
            class="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm"
            @click.self="showForgotModal = false" @keydown.escape.window="showForgotModal = false">
            <div x-show="showForgotModal" x-transition:enter="transition ease-out duration-200"
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                    Silakan hubungi <strong class="text-gray-800 dark:text-white">Humas/Admin Sekolah</strong> untuk
                    mereset kata sandi akun Anda. Sampaikan nama lengkap dan email yang terdaftar.
                </p>

                <button @click="showForgotModal = false" type="button"
    ...
    <div class="fixed bottom-6 right-6 z-[9999]">
        <button onclick="toggleSipklTheme()"
