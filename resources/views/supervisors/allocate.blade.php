...
<div class="flex flex-col gap-6" x-data="{
    ...
    ">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <!-- Save Button (Fixed Position on Mobile or Normal on Desktop) -->
        ...
        <form x-ref="form" action="{{ route('supervisors.allocate.bulk') }}" method="POST" class="w-full">
            ...
            <div
                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="h-9 w-9 rounded-full bg-school-blue/10 text-school-blue flex items-center justify-center text-xs font-bold">
                                                {{ substr($supervisor->user->name, 0, 2) }}
                                            </div>
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-white">
                                                    {{ $supervisor->user->name }}</div>
                                                <div class="text-sm text-gray-400">{{ $supervisor->nip }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="relative flex items-center justify-center"
                                            ...
                                            <input type="number" name="allocations[{{ $supervisor->user_id }}]"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center justify-center gap-2">
                                            ...
                                            <p class="text-base">Belum ada data guru pembimbing.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-400">Menampilkan {{ count($supervisors) }} guru
                        pembimbing</span>
