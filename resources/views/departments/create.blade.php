                ...
                <ol class="flex items-center gap-1.5 text-sm">
                    <li>
                        <a class="font-medium text-gray-400 dark:text-amoled-text hover:text-school-blue transition duration-150"
                            href="{{ route('departments.index') }}">Program Keahlian</a>
                    </li>
                    <li class="text-gray-300 dark:text-gray-600">/</li>
                    <li class="font-medium text-gray-800 dark:text-gray-200">Tambah Program Keahlian Baru</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="p-6 sm:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            placeholder="cth. Pengembangan Perangkat Lunak dan Gim" required
