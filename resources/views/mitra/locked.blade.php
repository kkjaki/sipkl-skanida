...
@section('content')
    <div
        class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-amoled-border dark:bg-amoled-surface p-8 sm:p-12 text-center">
        ...
        <p class="text-gray-500 dark:text-amoled-text leading-relaxed max-w-sm mx-auto mb-8">
            Data kesanggupan dan PIC sertifikat untuk <strong>{{ $industry->name }}</strong> sudah berhasil dikirim dan saat
            ini sedang dalam proses verifikasi oleh tim Hubin.
        </p>

        <!-- Read Only Summary -->
        <div
            class="bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.05] rounded-2xl p-6 mb-8 text-left">
            <h3 class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4">Ringkasan Data
                PIC:</h3>
            <div class="space-y-4">
                <div
                    class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 border-b border-gray-100 dark:border-white/[0.05] pb-3">
